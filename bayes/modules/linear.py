...
class BayesLinear(Module):
    ...
    def __init__(self, prior_mu, prior_sigma, in_features, out_features, sigma_init = None ,bias=True):
    ...
    def reset_parameters(self):
        ...
        self.weight_log_sigma.data.fill_(self.log_sigma_init)
        if self.bias :
            self.bias_mu.data.uniform_(-stdv, stdv)
            # self.bias_log_sigma.data.fill_(self.prior_log_sigma)
            self.bias_log_sigma.data.fill_(self.log_sigma_init)
